...
import { getFirestore, collection, getDoc, getDocs, doc, setDoc, query, where } from 'firebase/firestore/lite';
...
export { auth, db, signIn, signOut, signUp, handleSignOut,
    onAuthStateChanged, collection, getDoc, getDocs, doc, setDoc,
    roleData, data, query, where };
